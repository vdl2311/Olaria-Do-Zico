  ...
  return (
    <div className="fixed bottom-16 lg:bottom-8 right-3 sm:right-6 lg:right-8 z-30 font-brand-sans">
      <button
        ...
        className="group relative flex items-center space-x-2.5 bg-[#B85C38] hover:bg-[#9E4A2A] text-white font-bold text-xs sm:text-sm px-4 sm:px-5 py-3 sm:py-3.5 rounded-full shadow-xl hover:shadow-[#8A5A44]/40 transition-all transform hover:scale-105 active:scale-95 border-2 border-[#CF734E]/60 cursor-pointer focus-visible:outline-2 focus-visible:outline-[#B85C38]"
      ...
      >
        ...
        <span className="tracking-wider uppercase font-bold">Falar</span>
      </button>
    </div>
  );
};
